...
<svg width="3000" height="165" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="725" y="80" text-anchor="middle" style="font-size: 20px; fill: blue; ">Trần Nhân Tông</text>
  ...
  <text x="930" y="80" text-anchor="middle"  style="font-size: 20px;  ">Trần Thị Trinh  </text>
...
<svg width= "3000" height="1700" xmlns="http://www.w3.org/2000/svg" id="Text" style="display: none;">
   ...
   <line x1="500" y1="200" x2="1100" y2="200" id="redLine" style="stroke:black;stroke-width:5px; " />
  ...
  <text x="500" y="350" text-anchor="middle" id="Text1" style="font-size: 20px; fill: blue; ;">Trần Quốc Khang</text>
  <text x="500" y="370" text-anchor="middle" id="Text1" style="font-size: 20px; fill: blue ;">(con trai) </text>
  ...
  <text x="700" y="350" text-anchor="middle" id="Text1" style="font-size: 20px; fill: blue; ;">Trần Thuyên</text>
  ...
  <text x="900" y="350" text-anchor="middle" id="Text1" style="font-size: 20px;  ;">Từ Thuận Thiên</text>
  ...
  <text x="1100" y="350" text-anchor="middle" id="Text1" style="font-size: 20px; fill: blue; ;">Huyền Trân</text>
